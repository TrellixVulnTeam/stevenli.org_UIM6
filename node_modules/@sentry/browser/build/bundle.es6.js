...
var Sentry = (function (exports) {
  ...
  class API {
      ...
      constructor(dsn, metadata = {}, tunnel) {
          this.dsn = dsn;
  ...
  class BaseClient {
      ...
      _updateSessionFromEvent(session, event) {
          ...
          if (shouldUpdateAndSend) {
              session.update(Object.assign(Object.assign({}, (crashed && { status: SessionStatus.Crashed })), { errors: session.errors || Number(errored || crashed) }));
  ...
  ***************************************************************************** */
  ...
  function sessionToSentryRequest(session, api) {
      ...
      const envelopeHeaders = JSON.stringify(Object.assign(Object.assign({ sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (api.forceEnvelope() && { dsn: api.getDsn().toString() })));
  ...
  function eventToSentryRequest(event, api) {
      ...
      if (useEnvelope) {
          const envelopeHeaders = JSON.stringify(Object.assign(Object.assign({ event_id: event.event_id, sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (api.forceEnvelope() && { dsn: api.getDsn().toString() })));
          const itemHeaders = JSON.stringify({
              type: eventType,
  ...
  class BrowserBackend extends BaseBackend {
      ...
      _setupTransport() {
          ...
          const transportOptions = Object.assign(Object.assign({}, this._options.transportOptions), { dsn: this._options.dsn, tunnel: this._options.tunnel, _metadata: this._options._metadata });
